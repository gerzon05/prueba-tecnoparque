...
export default function Battle({ pokemondatails, pokemonAuto }: { pokemondatails: any, pokemonAuto: any }) {
    ...
    return (
        <div className="relative flex gap-10 justify-between items-center mt-5 font-bold">
            <article className='w-2/5 relative'>
                ...
                />
                {two <= 0 &&  <div className='text-center text-2xl animate-pulse font-bold'>Winnern</div>}
                <div className='mt-10 flex flex-col gap-2 px-4'>
                    <figure className='w-full flex justify-between items-center'>
                        <Badge variant={'outline'} className='hidden md:block text-md'>Life {one >= 0 ? one : 0}%</Badge>
            ...
            <article className='w-2/5'>
                <Image
                    ...
                    className="object-contain fondo"
                />
                {one <= 0 && <div className='text-center text-2xl animate-pulse font-bold'>Winnern</div>}
                <div className='mt-10 flex flex-col gap-2 px-4'>
                    <figure className='flex justify-end md:justify-between w-full items-center'>
                        <Badge variant={'outline'} className='hidden md:block text-md'>Life {two >= 0 ? two : 0}%</Badge>
