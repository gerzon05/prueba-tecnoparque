    ...
    <>
      <div className="relative px-10">
        <section className="w-1/2 mt-5 md:mt-0 pl-2 md:pl-10 pt-2 md:pt-10">
          <p className="text-sm md:text-2xl">Select your two</p>
          <h1 className="text-4xl md:text-6xl font-bold text-center flex w-full gap-2 items-center">
            Pokemon{' '}
            <Image
              src={LogoPokemonesMini}
              alt="logo de Pokemones"
                      ...
                      <div className="p-1">
                        <Card className="bg-transparent">
                          <CardContent className="flex flex-col p-0 aspect-square items-center justify-center size-fit relative">
                            <h1 className="text-white py-4 text-3xl font-semibold">
                              {pokemon.name}
                            </h1>
                            <Image
                              src={
                                pokemondatails.sprites.other.home.front_default
                              }
                              alt={pokemon.name}
                              width={1000}
                              height={1000}
                            ...
                            <div className="p-4 flex justify-evenly w-full">
                              ...
                              <Button className='w-full' asChild><Link href={`/pokemon/${pokemon.name}`} >More</Link></Button>
      ...
      <figure className="pl-10 mb-10 w-40 text-lg">
        12 Pokemon in your Pokèdex
      </figure>
      <Image
        src={LogoPokemones}
